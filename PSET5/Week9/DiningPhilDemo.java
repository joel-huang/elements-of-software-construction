	...
	public void run() {
		...
		try {
			while (true) {
                ...
                /* induce a random delay, philosophers hold the left fork for a while for some reason
                there is a higher probability of a left fork not being available to pickup()
                which leads to a higher probability of all forks being held at the same time
                 */
